...
def verify_token(token: str):
    """
    Call the auth_service to verify the token. not used
    """
    response = requests.get(f"/verify-token", params={"token": token})
...
fake_users_db = {
    "admin_cadappar": {
        "username": "admin_cadappar",
        "full_name": "CADAPPAR system admin",
        "email": "awa.tiam@univ-thies.sn",
